...
public class CalculadoraAmericana extends BaseDecorator {
	...
	public double bmr(char genero, int edad, float altura, int peso) throws Exception {
		...
		System.out.println("La persona con altura " + height + " metros y " + Math.round(weight / 1000)
				+ " Kg tiene un BMR de " + resultado);
		System.out.println("The person " + height + " meters tall and " + Math.round(weight / 1000)
				+ " Kg has a BMR of " + resultado);
		return resultado;
	}
